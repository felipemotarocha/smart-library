...
export const MOCKED_GENRE_WITH_ID_STRINGFIED = {
	...MOCKED_GENRE,
	_id: MOCKED_GENRE_ID_STRINGFIED,
};
...
export const MOCKED_AUTHOR_WITH_ID_STRINGFIED = {
	...MOCKED_AUTHOR,
	_id: MOCKED_AUTHOR_ID_STRINGIFIED,
};
...
export const MOCKED_BOOK_WITH_ID_STRINGFIED = {
	...MOCKED_BOOK,
	_id: MOCKED_BOOK_ID_STRINGFIED,
};
